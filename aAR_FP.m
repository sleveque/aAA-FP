function [xnew, iter, tol, anorm_story, rnorm_story, x_story] = aAR_FP(x0, it_fp, it_aa, m, rtol, maxit, fpiter)
    ...
    for k = 2 : maxit
        ...
        fprintf('Absolute norm: %e\n', norm_k)
%         fprintf('Relative norm: %e\n', norm_k / norm0)

        if norm_k < rtol% norm_k / norm0 < rtol%
            break
        end
